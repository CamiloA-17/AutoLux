...
import { createUser } from "@/libs/api_users"; // Asegúrate de que esta función funcione correctamente
...
export function Register() {
  ...
  const onSubmit: SubmitHandler<Inputs> = async (data) => {
    ...
    // Aquí estamos llamando a la función de creación de usuario
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        >
          ...
          <div>
            ...
            {errors.id && (
              <span className="text-red-500 text-sm">Cédula requerida</span>
            )}
          </div>
